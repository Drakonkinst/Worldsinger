...
public final class ModPayloadRegistry {
    ...
    public static void initialize() {
        // Bidirectional
        registerBidirectional(PossessSetPayload.ID, PossessSetPayload.CODEC);
        ...
        PayloadTypeRegistry.playC2S()
                .register(ItemContainerItemSelectedPayload.ID,
                        ItemContainerItemSelectedPayload.CODEC);
    ...
    private static <T extends CustomPayload> void registerBidirectional(CustomPayload.Id<T> id,
